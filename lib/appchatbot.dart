...
class Appchatbot extends StatefulWidget {
  const Appchatbot({Key? key, required String title}) : super(key: key);

  @override
  State<Appchatbot> createState() => _AppchatbotState();
}

class _AppchatbotState extends State<Appchatbot>
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      request.fields['chat'] = userMessage;
  ...
  //   // try {
  //
  //   String ans=_textController.text;
  //   _messages.add(ChatMessage(
  //     text: ans,
  //     isUser: true,
  //     timestamp: DateTime.now(),
  ...
  //
  //       'chat': _textController.text.trim(),
  //     });
  //
  //     final streamedResponse = await request.send();
  //     final response = await http.Response.fromStream(streamedResponse);
